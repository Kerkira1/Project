...
namespace Project
{
    public partial class Second_MazeForm : Form
    {
        private static Second_MazeForm _instance;
        public static Second_MazeForm Instance
        {
            get
            {
                if (_instance == null || _instance.IsDisposed)
                {
                    _instance = new Second_MazeForm();
                }
                else
                {
